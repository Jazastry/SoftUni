...
namespace Homework
{
    ...
    public partial class SoftUniEntities : DbContext
    {
        ...
        public virtual ObjectResult<usp_Project_By_Employee_Result> usp_Project_By_Employee(string employeeFirstName, string employeeLastName)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<usp_Project_By_Employee_Result>("usp_Project_By_Employee", employeeFirstNameParameter, employeeLastNameParameter);
        }
    }
}
